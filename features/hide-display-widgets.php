<?php
global $show_hide_feature;
$show_hide_feature = new WMDisplayWidgetsFeature();

class WMDisplayWidgetsFeature{
    var $transient_name = 'show_hide_details';
    var $checked = array();
    var $id_base = '';
    var $number = '';
...
?>   
    <p>
        <label for="<?php echo $widget->get_field_id('dw_include'); ?>">Show this Widget for</label>
        <select name="<?php echo $widget->get_field_name('dw_logged'); ?>" id="<?php echo $widget->get_field_id('dw_logged'); ?>" class="widefat">
            ...
            <option value="out" <?php echo selected( $instance['dw_logged'], 'out' ) ?>>Not Logged-in visitors/users</option>
     ...
     <p>
    	<select name="<?php echo $widget->get_field_name('dw_include'); ?>" id="<?php echo $widget->get_field_id('dw_include'); ?>" class="widefat">
            <option value="0">Hide on below checked pages</option> 
            <option value="1" <?php echo selected( $instance['dw_include'], 1 ) ?>>Show on below checked pages</option>
        </select>
    </p>    
